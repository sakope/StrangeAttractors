    ...
    public class LorenzAttrator : StrangeAttractor
    {
        ...
        protected sealed override void InitializeComputeBuffer()
        {
            ...
            for (int i = 0; i < instanceCount; i++)
            {
                ...
                //Start with oneline
                //parameters[i] = new Params(Vector3.one * emitterSize * normalize, particleSize, color);
                //Start with delayed two lines
                //parameters[i] = new Params(Vector3.one * -1.0f * emitterSize * normalize + Vector3.one * emitterSize * 0.5f, particleSize, color);
            }
